  ...
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll">
      ...
      >
        ...
        <span v-if="!isAffix(tag)" class="mdi mdi-close" @click.prevent.stop="closeSelectedTag(tag)" />
      </router-link>
    </scroll-pane>
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      <li @click="refreshSelectedTag(selectedTag)">{{ $t(`general.refresh`) }}</li>
      <li v-if="!isAffix(selectedTag)" @click="closeSelectedTag(selectedTag)">{{ $t(`general.close`) }}</li>
      <li @click="closeOthersTags">{{ $t(`general.closeOthers`) }}</li>
      <li @click="closeAllTags(selectedTag)">{{ $t(`general.closeAll`) }}</li>
    </ul>
  </div>
</template>
